    ...
    async submitChildren() {
        ...
        try {
            ...
            if (response.ok) {
                ...
                alert("Children submitted successfully!");
            } else {
                alert("Error: " + (result.message || "Unknown error"));
            }
        } catch (error) {
            console.error("Error submitting children:", error);
            alert("Error submitting children. Please try again.");
        }
    },
