                     ...
                     <ul class="navbar-nav ml-auto navbar-list align-items-center">
                         ...
                         <li class="nav-item nav-icon dropdown">
                             <a href="#" class="search-toggle dropdown-toggle" id="dropdownMenuButton2"
                                 data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                 <img src="../assets/images/Flag/flag-04.png" class="img-fluid rounded-circle"
                                         ...
                                         <ul class="dropdown-menu-1 list-group list-group-flush">
                                             ...
                                             <li class="dropdown-item-1 list-group-item  px-2"><a class="p-0"
                                                     href="#"><img src="../assets/images/Flag/flag-04.png"
                                                         alt="img-flaf" class="img-fluid mr-2"
                                                         style="width: 15px;height: 15px;min-width: 15px;" />India</a>
                                             </li>
                                             <li class="dropdown-item-1 list-group-item  px-2"><a class="p-0"
                         ...
                         <li class="nav-item nav-icon dropdown">
                             <a href="#" class="nav-item nav-icon dropdown-toggle pr-0 search-toggle"
                                 ...
                                 <img src="../assets/images/user/1.jpg" class="img-fluid avatar-rounded"
                                     alt="user">
                                 <span class="mb-0 ml-2 user-name">Pawan</span>
                             </a>
